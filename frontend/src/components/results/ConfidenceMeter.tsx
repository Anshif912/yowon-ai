  ...
  return (
    <div className="glass-card p-5">
      <div className="flex items-center gap-2 mb-4">
        <Brain size={16} className="text-yowon-accent" />
        <span className="text-xs font-mono text-yowon-muted uppercase tracking-widest">
          {label}
        </span>
      </div>
      <div className="relative h-3 rounded-full bg-yowon-border overflow-hidden">
        <motion.div
          className="absolute inset-y-0 left-0 rounded-full bg-gradient-to-r from-yowon-primary via-yowon-accent to-amber-300"
          initial={{ width: 0 }}
      ...
      <div className="flex justify-between mt-2">
        ...
        <span className="text-xs text-yowon-muted self-end">Neural certainty index</span>
      </div>
    </div>
  )
}
