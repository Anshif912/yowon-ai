...
const NODES = [
  ...
  { id: 'technical', icon: Cpu, label: 'Engineering', angle: 51, color: '#00E5FF' },
  { id: 'security', icon: Shield, label: 'Security', angle: 103, color: '#EF4444' },
  { id: 'presentation', icon: Presentation, label: 'Presentation', angle: 154, color: '#7C3AED' },
  { id: 'innovation', icon: Lightbulb, label: 'Innovation', angle: 206, color: '#00FFA3' },
  { id: 'risk', icon: Globe, label: 'Risk', angle: 257, color: '#00FFA3' },
  { id: 'chief', icon: Gavel, label: 'Chief', angle: 309, color: '#7C3AED' },
]
